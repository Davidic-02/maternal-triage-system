...
return medicalIdChanged(_that);case _Submit() when submit != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _SignUpEvent value)  $default,{required TResult Function( _NameChanged value)  nameChanged,required TResult Function( _RoleChanged value)  roleChanged,required TResult Function( _EmailChanged value)  emailChanged,required TResult Function( _PasswordChanged value)  passwordChanged,required TResult Function( _MedicalIdChanged value)  medicalIdChanged,required TResult Function( _Submit value)  submit,required TResult Function( _SubmitSuccessful value)  submitSuccessful,required TResult Function( _SubmitFailed value)  submitFailed,required TResult Function( _ErrorMessage value)  errorMessage,}){
final _that = this;
switch (_that) {
case _SignUpEvent():
...
return medicalIdChanged(_that);case _Submit():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _SignUpEvent value)?  $default,{TResult? Function( _NameChanged value)?  nameChanged,TResult? Function( _RoleChanged value)?  roleChanged,TResult? Function( _EmailChanged value)?  emailChanged,TResult? Function( _PasswordChanged value)?  passwordChanged,TResult? Function( _MedicalIdChanged value)?  medicalIdChanged,TResult? Function( _Submit value)?  submit,TResult? Function( _SubmitSuccessful value)?  submitSuccessful,TResult? Function( _SubmitFailed value)?  submitFailed,TResult? Function( _ErrorMessage value)?  errorMessage,}){
final _that = this;
switch (_that) {
case _SignUpEvent() when $default != null:
return $default(_that);case _NameChanged() when nameChanged != null:
...
return medicalIdChanged(_that.id);case _Submit() when submit != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function()  $default,{required TResult Function( String name)  nameChanged,required TResult Function( String role)  roleChanged,required TResult Function( String email)  emailChanged,required TResult Function( String password)  passwordChanged,required TResult Function( String id)  medicalIdChanged,required TResult Function()  submit,required TResult Function()  submitSuccessful,required TResult Function( String? message)  submitFailed,required TResult Function( String? message)  errorMessage,}) {final _that = this;
switch (_that) {
case _SignUpEvent():
...
return medicalIdChanged(_that.id);case _Submit():
...
mixin _$SignUpState {
 ...
 FormzSubmissionStatus get status; EmailFormz get email; PasswordFormz get password; NameFormz get name; RoleFormz get role; MedicalIdFormz get medicalId; String? get errorMessage;
...
@override
int get hashCode => Object.hash(runtimeType,status,email,password,name,role,medicalId,errorMessage);

@override
String toString() {
  return 'SignUpState(status: $status, email: $email, password: $password, name: $name, role: $role, medicalId: $medicalId, errorMessage: $errorMessage)';
}
...
@useResult
$Res call({
 FormzSubmissionStatus status, EmailFormz email, PasswordFormz password, NameFormz name, RoleFormz role, MedicalIdFormz medicalId, String? errorMessage
});
...
/// Create a copy of SignUpState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? status = null,Object? email = null,Object? password = null,Object? name = null,Object? role = null,Object? medicalId = null,Object? errorMessage = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( FormzSubmissionStatus status,  EmailFormz email,  PasswordFormz password,  NameFormz name,  RoleFormz role,  MedicalIdFormz medicalId,  String? errorMessage)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SignUpState() when $default != null:
return $default(_that.status,_that.email,_that.password,_that.name,_that.role,_that.medicalId,_that.errorMessage);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( FormzSubmissionStatus status,  EmailFormz email,  PasswordFormz password,  NameFormz name,  RoleFormz role,  MedicalIdFormz medicalId,  String? errorMessage)  $default,) {final _that = this;
switch (_that) {
case _SignUpState():
return $default(_that.status,_that.email,_that.password,_that.name,_that.role,_that.medicalId,_that.errorMessage);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( FormzSubmissionStatus status,  EmailFormz email,  PasswordFormz password,  NameFormz name,  RoleFormz role,  MedicalIdFormz medicalId,  String? errorMessage)?  $default,) {final _that = this;
switch (_that) {
case _SignUpState() when $default != null:
return $default(_that.status,_that.email,_that.password,_that.name,_that.role,_that.medicalId,_that.errorMessage);case _:
  return null;
...
class _SignUpState extends SignUpState {
  const _SignUpState({this.status = FormzSubmissionStatus.initial, this.email = const EmailFormz.pure(), this.password = const PasswordFormz.pure(), this.name = const NameFormz.pure(), this.role = const RoleFormz.pure(), this.medicalId = const MedicalIdFormz.pure(), this.errorMessage}): super._();
...
/// Create a copy of SignUpState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? status = null,Object? email = null,Object? password = null,Object? name = null,Object? role = null,Object? medicalId = null,Object? errorMessage = freezed,}) {
