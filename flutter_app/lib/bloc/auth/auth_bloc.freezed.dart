...
return passwordChanged(_that);case _Login() when login != null:
return login(_that);case _LoginSuccessful() when loginSuccessful != null:
return loginSuccessful(_that);case _LoginFailed() when loginFailed != null:
return loginFailed(_that);case _ErrorMessage() when errorMessage != null:
return errorMessage(_that);case _ForgotPassword() when forgotPassword != null:
return forgotPassword(_that);case _ForgotPasswordSuccessful() when forgotPasswordSuccessful != null:
...
return passwordChanged(_that);case _Login():
return login(_that);case _LoginSuccessful():
return loginSuccessful(_that);case _LoginFailed():
return loginFailed(_that);case _ErrorMessage():
return errorMessage(_that);case _ForgotPassword():
return forgotPassword(_that);case _ForgotPasswordSuccessful():
...
return passwordChanged(_that.password);case _Login() when login != null:
return login();case _LoginSuccessful() when loginSuccessful != null:
return loginSuccessful();case _LoginFailed() when loginFailed != null:
return loginFailed(_that.message);case _ErrorMessage() when errorMessage != null:
return errorMessage(_that.message);case _ForgotPassword() when forgotPassword != null:
return forgotPassword();case _ForgotPasswordSuccessful() when forgotPasswordSuccessful != null:
...
return passwordChanged(_that.password);case _Login():
return login();case _LoginSuccessful():
return loginSuccessful();case _LoginFailed():
return loginFailed(_that.message);case _ErrorMessage():
return errorMessage(_that.message);case _ForgotPassword():
return forgotPassword();case _ForgotPasswordSuccessful():
...
/// @nodoc
abstract mixin class _$ErrorMessageCopyWith<$Res> implements $AuthEventCopyWith<$Res> {
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _UserChanged);
}
