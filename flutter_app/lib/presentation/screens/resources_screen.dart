// lib/presentation/screens/resources_screen.dart (FINAL - USING EXISTING WIDGETS)
...
class EducationalLibraryScreen extends HookWidget {
  ...
  Widget _buildContent(
    ...
    // ERROR STATE - USING EMPTY_STATE WIDGET
    ...
    return ListView(
      ...
      children: [
        ...
        // SEARCH BAR - USING CUSTOM_TEXT_FORM_FIELD
        Padding(
      ...
      child: Padding(
        ...
        child: Row(
          ...
          if (state.filteredVideos.isEmpty)
            EmptyState(message: 'No results for "${state.searchQuery}"')
          else
            SizedBox(
              height: 220,
              child: ListView.builder(
        ...
        if (state.filteredGuides.isEmpty)
          const EmptyState(message: 'No guides found')
        else
          Padding(
            padding: const EdgeInsets.symmetric(horizontal: 20),
            child: Card(
